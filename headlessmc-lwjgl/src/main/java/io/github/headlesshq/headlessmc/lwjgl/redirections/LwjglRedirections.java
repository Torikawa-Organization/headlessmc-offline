...
import io.github.headlesshq.headlessmc.lwjgl.redirections.stb.STBTrueTypeRedirections;
...
public class LwjglRedirections {
    ...
    private static final ThreadLocal<Long> CURRENT_BUFFER_SIZE = ThreadLocal.withInitial(() -> 0L);
    ...
    public static void register(RedirectionManager manager) {
        ...
        manager.redirect("Lorg/lwjgl/glfw/GLFW;glfwGetTime()D",
                (obj, desc, type, args) -> (System.nanoTime() - START) / 1_000_000_000.0D);
        ...
        manager.redirect("Lorg/lwjgl/Sys;getTimerResolution()J",
                of(1000L));
        manager.redirect("Lorg/lwjgl/Sys;getTime()J", (obj, desc, type, args) -> System.nanoTime() / 1000000L);
        ...
        manager.redirect("Lorg/lwjgl/opengl/GL11;glGetTexLevelParameteri(III)I",
                (obj, desc, type, args) -> {
                    if ((int) args[2] == GL_TEXTURE_INTERNAL_FORMAT_CONST) {
                        ...
                        return 0; // otherwise Neoforge 1.21.5 gets caught in an endless loop of checking width !=
                                  // 0; for higher levels
                    }
        ...
        // STB TrueType font redirections for mods like Meteor Client
        STBTrueTypeRedirections.redirect(manager);
        ...
        // java.base@17.0.12 (33 bytes) @ 0x00007ea004efdf19
        // [0x00007ea004efdda0+0x0000000000000179]
        ...
        // j
        // net.minecraft.class_287.push(Lorg/lwjgl/system/MemoryStack;JILnet/caffeinemc/mods/sodium/api/vertex/format/VertexFormatDescription;)V+47
        // j
        // me.jellysquid.mods.sodium.client.render.vertex.buffer.SodiumBufferBuilder.push(Lorg/lwjgl/system/MemoryStack;JILnet/caffeinemc/mods/sodium/api/vertex/format
        ...
        // at
        // TRANSFORMER/minecraft@1.21.10/com.mojang.blaze3d.opengl.GlDevice.createTexture(GlDevice.java:119)
        // ~[forge-1.21.10-60.0.17-client.jar:?]
